...
public class Fly extends Move
{
	public Fly()
	{
		super("Fly", PokemonGame.Flying, 0, 15, 90, 95, 2, 0);
	}
	...
	{
		//cant switch out while under ground. 
		if(getCurrentTurnCompletion() != 1)
		{
			System.out.println(Attacker.getPoke().name + " flew up high!");
			Attacker.setProtected("Fly");
		}
