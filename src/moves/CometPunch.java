...
public class CometPunch extends Move
{
	public CometPunch()
	{
		super("Comet Punch", PokemonGame.Normal, 0, 15, 18, 85, 1, 0);
	}
	...
	public void secondaryEffect(SeenPokemon Attacker, SeenPokemon Defender, int Damage)//Comet Punch inflicts damage, hitting the target 2-5 times per use. There is a 37.5% chance that it will hit 2 times, a 37.5% chance that it will hit 3 times, a 12.5% chance that it will hit 4 times, and a 12.5% chance that it will hit 5 times.
	{
