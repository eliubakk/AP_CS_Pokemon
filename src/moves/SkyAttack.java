...
public class SkyAttack extends Move
{
	public SkyAttack()
	{
		super("Sky Attack", PokemonGame.Flying, 0, 5, 140, 90, 2, 0);
	}
	...
	{
		//The user is glowing the first turn, then attacks the second turn.  Has a 30% chance to flinch.
		if(getCurrentTurnCompletion() == 2)
			System.out.println(Attacker.getPoke().name + " is glowing!");
		else
		{
