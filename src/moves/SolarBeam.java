...
public class SolarBeam extends Move
{
	public SolarBeam()
	{
		super("Solar Beam", PokemonGame.Grass, 1, 10, 120, 100, 2, 0);
	}
	...
	{
		//Charges on the first turn, then uses the turn on the second turn.  No charging turn is needed in the sun light.  does half damage in the rain or sandstorm or hail.
		System.out.println(Attacker.getPoke().name + " absorbed sunlight!");
	}
}
