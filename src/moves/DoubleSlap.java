...
public class DoubleSlap extends Move
{
	public DoubleSlap()
	{
		super("Double Slap", PokemonGame.Normal, 0, 10, 15, 85, 1, 0);
	}
	...
	public void secondaryEffect(SeenPokemon Attacker, SeenPokemon Defender, int Damage)//DoubleSlap inflicts damage, hitting the target 2-5 times per use. There is a 37.5% chance that it will hit 2 times, a 37.5% chance that it will hit 3 times, a 12.5% chance that it will hit 4 times, and a 12.5% chance that it will hit 5 times. 
	{
