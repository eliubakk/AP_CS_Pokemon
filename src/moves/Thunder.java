...
public class Thunder extends Move
{
	public Thunder()
	{
		super("Thunder", PokemonGame.Electric, 1, 10, 120, 70, 1, 0);
	}
	...
	{
		//30% chance to paralyze the target.  100% accuracy in the rain.  50 accuracy when used during sunlight. double damage if used on a pokemon in the air during fly or bounce. 
