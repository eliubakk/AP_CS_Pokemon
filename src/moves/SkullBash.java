...
public class SkullBash extends Move
{
	public SkullBash()
	{
		super("Skull Bash", PokemonGame.Normal, 0, 10, 130, 100, 2, 0);
	}
	...
	{
		//Lowers it's head the first turn while raising its defense, then attacks the next turn
		System.out.println(Attacker.getPoke().name + " lowered it's head!");
		Attacker.raiseDefenseMultiplier();
		System.out.println("It's defense rose!");
	}
}
