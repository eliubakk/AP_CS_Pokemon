...
public class KarateChop extends Move
{
	public KarateChop()
	{
		super("Karate Chop", PokemonGame.Fighting, 0, 25, 50, 100, 1, 0);
	}
	...
	public void secondaryEffect(SeenPokemon Attacker, SeenPokemon Defender, int Damage)//increased critical hit ratio
	{
