...
public class PinMissile extends Move
{
	public PinMissile()
	{
		super("Pin Missile", PokemonGame.Bug, 0, 20, 25, 100, 1, 0);
	}
	...
	{
		//hitting the target 2-5 times per use. There is a 37.5% chance that it will hit 2 times, a 37.5% chance that it will hit 3 times, a 12.5% chance that it will hit 4 times, and a 12.5% chance that it will hit 5 times. 
	}
}
